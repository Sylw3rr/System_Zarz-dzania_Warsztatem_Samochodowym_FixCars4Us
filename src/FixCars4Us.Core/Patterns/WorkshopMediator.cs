// Wzorzec: Mediator — przypisywanie zasobów warsztatowych (mechanik, podnośnik, narzędzie).
...
/// <summary>Zajętość zasobu w danym przedziale czasu (tylko wewnątrz Mediatora).</summary>
internal record Booking(int ResourceId, DateTime Start, DateTime End);

/// <summary>Mediator — koordynuje przydział mechanika, podnośnika i narzędzia naraz.</summary>
public class WorkshopMediator
{
    ...
    // Test zachodzenia przedziałów czasowych [start, end) i [b.Start, b.End).
    ...
    /// <summary>Przydziela komplet zasobów atomowo — tylko gdy wszystkie są dostępne.</summary>
    public ResourceAllocation TryAllocate(ResourceRequest req)
    {
        ...
        // Rezerwacja atomowa — albo wszystkie zasoby naraz, albo żaden.
