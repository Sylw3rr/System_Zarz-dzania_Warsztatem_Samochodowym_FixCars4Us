// Wzorzec: Strategy (koszt robocizny) + Decorator (warstwy modyfikatorów ceny).
...
/// <summary>Opis pojedynczej warstwy modyfikującej cenę (do budowy potoku Decoratorów).</summary>
...
/// <summary>Silnik wyceny naprawy — łączy Strategy z Decoratorem.</summary>
public class PricingService
{
    /// <summary>Buduje finalną wycenę: cena bazowa (części + robocizna), potem modyfikatory.</summary>
        ...
        IEnumerable<PriceModifier> modifiers)
    {
        ...
        // Rabat klienta nakładany jako ostatni, na cenę po wszystkich dopłatach.
