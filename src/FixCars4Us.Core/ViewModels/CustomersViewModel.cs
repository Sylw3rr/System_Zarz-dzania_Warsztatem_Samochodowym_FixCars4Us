...
/// <summary>ViewModel zakładki Klienci — kartoteka klientów, pojazdy, historia serwisowa.</summary>
public class CustomersViewModel : ViewModelBase
{
    ...
    /// <summary>Odświeża pojazdy i historię — inny moduł mógł dodać wpis w międzyczasie.</summary>
    public void Refresh()
    {
        LoadVehicles();
        LoadHistory();
