...
/// <summary>ViewModel zakładki Kalendarz przyjęć — planowanie wizyt z walidacją kolizji terminów.</summary>
public class AppointmentsViewModel : ViewModelBase
{
    ...
    // Przeładowuje też pojazdy/stanowiska — CreateOrder w RepairOrders mógł dodać wizytę z innej zakładki.
    ...
    private void AddAppointment(object? _)
    {
        ...
        // Test nakładania przedziałów: kolizja gdy start1 < end2 i start2 < end1.
