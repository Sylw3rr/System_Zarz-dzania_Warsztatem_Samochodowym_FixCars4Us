...
public static class DbInitializer
{
    public static void EnsureSeeded(WorkshopContext db)
    {
        ...
        if (db.Customers.Any()) return; // dane już zainicjowane
        ...
        // Klient prywatny bez rabatu i klient flotowy z 10% rabatem (DiscountDecorator).
        ...
        db.SaveChanges(); // nadaje Id, potrzebne do powiązania historii serwisowej
